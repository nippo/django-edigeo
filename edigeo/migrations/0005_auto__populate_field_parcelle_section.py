...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        for prc in orm['edigeo.parcelle'].objects.all():
            try:
                prc.section = orm['cad.Section'].objects.get(name=prc.idu[6:8], insee_id=prc.insee_id)
                prc.save()
            except:
                # @todo Fixe Parcelle sans lieudit
                continue
    ...
    models = {
        ...
        u'cad.section': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'insee': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['cad.Insee']"}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '50'})
        },
        u'edigeo.edigeobati': {
        ...
        u'edigeo.parcelle': {
            ...
            'section': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['cad.Section']", 'null': 'True'}),
