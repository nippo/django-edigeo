...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Parcelle.insee'
        db.add_column(u'edigeo_parcelle', 'insee',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cad.Insee'], null=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Parcelle.insee'
        db.delete_column(u'edigeo_parcelle', 'insee_id')
